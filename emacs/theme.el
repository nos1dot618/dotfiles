;;; tsdh-dark-improved-theme.el --- Improved Tassilo's dark custom theme

(deftheme tsdh-dark-improved
  "An improved dark theme created and used by ninthcircle.")
...
(custom-theme-set-faces
 ...
 '(ivy-minibuffer-match-face-2 ((t (:background "gray50" :weight bold))))
 ...
 '(minibuffer-prompt ((t (:foreground "deep pink" :weight bold))))
 '(mode-line ((t (:background "gray75" :box (:line-width 1 :style released-button) :foreground "black"))))
 '(mode-line-inactive ((t (:background "gray40" :box (:line-width 1 :color "gray40" :style nil) :foreground "black"))))
...
(provide-theme 'tsdh-dark-improved)

;;; tsdh-dark-improved-theme.el ends here
