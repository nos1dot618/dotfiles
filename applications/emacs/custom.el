...
(custom-set-variables
 ...
 '(package-selected-packages
   '(clojure-mode company d-mode fish-mode go-mode haskell-mode helm-flx markdown-mode multiple-cursors nix-mode powershell
                  rust-mode zenburn-theme zig-mode)))
(custom-set-faces
